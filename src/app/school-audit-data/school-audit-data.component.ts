...
export class SchoolAuditDataComponent {
  displayedColumns: string[] = ['udiseNo', 'schoolType', 'schoolName', 'district', 'educationalDistrict', 'headmasterName', 'headmasterRetirementDate', 'headmasterMobileNo', 'email', 'studentsStrength', 'teachersStrength', 'clericalStrength', 'lastAuditingPeriod', 'lastAuditingDate', 'action'];
  dataSource: School[] = [];
